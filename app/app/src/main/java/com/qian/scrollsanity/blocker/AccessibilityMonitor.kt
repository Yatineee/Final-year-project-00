...
class AccessibilityMonitorService : AccessibilityService() {
    ...
    companion object {
        ...
        private const val EXTRA_MODE = BlockerActivity.EXTRA_MODE
        private const val MODE_ASK_MENTAL_STATE = BlockerActivity.MODE_ASK_MENTAL_STATE
        private const val MODE_BLOCK = BlockerActivity.MODE_BLOCK
    ...
    private fun showMentalStatePrompt(pkg: String, z: Double) {
        val i = Intent(this, BlockerActivity::class.java).apply {
            ...
            putExtra(BlockerActivity.EXTRA_TARGET_PKG, pkg)
            putExtra(BlockerActivity.EXTRA_Z, z)
    ...
    private fun showInterventionPlaceholder(
        ...
        val i = Intent(this, BlockerActivity::class.java).apply {
            ...
            putExtra(BlockerActivity.EXTRA_Z, z)
            putExtra(BlockerActivity.EXTRA_MENTAL_STATE, mental)
            putExtra(BlockerActivity.EXTRA_ENGAGING, engaging)
